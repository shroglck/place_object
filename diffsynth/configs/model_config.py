...
model_loader_configs = [
    ...
    # (hash from local checkpoint; contains DiT + VAE weights, text encoders loaded separately)
    (None, "a04c0f178d841dd0f13a255dd4be9582", ["sd3_dit", "sd3_vae_encoder", "sd3_vae_decoder"], [SD3DiT, SD3VAEEncoder, SD3VAEDecoder], "civitai"),
